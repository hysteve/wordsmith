/**
 * Interactive category picker. This is a terminal prompt, so it lives in the
 * CLI and not in core — core had it, which meant importing shared logic
 * dragged in inquirer and a question no web caller can answer.
 */
import inquirer from 'inquirer';
import fs from 'fs';
import path from 'path';
import prefixes from '@wordsmith/core/data/prefixes.js';
